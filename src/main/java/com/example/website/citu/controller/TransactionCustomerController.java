...
public class TransactionCustomerController {
    ...
    public String senderDto(
        ...
        String url = address + "/customerTransactions?address=" + pubkey + "&from=" + from + "&to=" + to;
    ...
    @GetMapping("/transactionsCustomer")
    public String transactions(
        ...
        if (httpSession.getAttribute("transactions") != null) {
            ...
            url = address + "/customerTransactions?address=" + pubkey + "&from=" + page + "&to=" + size;
        ...
        model.addAttribute("totalPages", totalTransactions);
    ...
    @PostMapping("/transactionsCustomer")
    public String transactions(HttpSession httpSession,
        ...
        return "redirect:/transactionsCustomer";
    ...
    public String send(String pubkey,
        ...
        str = "/customerTransactions?address=";
        System.out.println("***********************************");
        System.out.println("from: " + from);
        System.out.println("to: " + to);

        String urlCount = address + "/customerCountDto?address=" + pubkey;
